...
$_config = array(
     ...
     * 产品配置
     */
    'PRODUCT_NAME'    => 'samcms',                      // 产品名称
    'PRODUCT_LOGO'    => '<b><span class="open" style="color: #3fa9f5;">Sam</span><span class="cmf" style="color: #3fa9f5;">cms</span></b>',  // 产品Logo
    'CURRENT_VERSION' => '1.3.0',                        // 当前版本号
    'DEVELOP_VERSION' => 'release',                      // 开发版本号
    'BUILD_VERSION'   => '201608141951',                 // 编译标记
    'PRODUCT_MODEL'   => 'samcms',                    // 产品型号
    'PRODUCT_TITLE'   => '开源版',                        // 产品标题
    'WEBSITE_DOMAIN'  => 'http://www.samcms.com',      // 官方网址
    'UPDATE_URL'      => '/appstore/home/core/update',   // 官方更新网址
    'COMPANY_NAME'    => '新麦网络科技有限公司',     // 公司名称
    'DEVELOP_TEAM'    => '新麦网络科技有限公司',     // 当前项目开发团队名称

    // 产品简介
    'PRODUCT_INFO'    => 'SamCms是一套基于统一核心的通用互联网+信息化服务解决方案，追求简单、高效、卓越。可轻松实现支持多终端的WEB产品快速搭建、部署、上线。系统功能采用模块化、组件化、插件化等开放化低耦合设计，应用商城拥有丰富的功能模块、插件、主题，便于用户灵活扩展和二次开发。',

    // 公司简介
    'COMPANY_INFO'    => '新麦网络科技有限公司是一家新兴的互联网+项目技术解决方案提供商。我们用敏锐的视角洞察IT市场的每一次变革,我们顶着时代变迁的浪潮站在了前沿,以开拓互联网行业新渠道为己任。',
