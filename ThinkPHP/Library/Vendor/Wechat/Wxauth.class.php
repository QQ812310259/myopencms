...
class Wxauth {
	...
	public function wxoauth(){
		...
		else
		{
			...
			$options = array(
					'token'=>'EwFlR20VUdBN8f5eTzzouOYXcIlLdT6h', //填写你设定的key
                    'encodingaeskey'=>'bc0adf7e6895eb76a22cbac1f2cb776d7dd7cb7ae1c', //填写加密用的EncodingAESKey
					'appid'=>'wx0d23e8c3dc6ea7ba', //填写高级调用功能的app id
					'appsecret'=>'326fe7705cec970a060cb5f88f7c67ba' //填写高级调用功能的密钥
			);
